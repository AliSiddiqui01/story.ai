...
describe('SafetyAlert Interface', () => {
  ...
  test('should create a valid SafetyAlert', () => {
    ...
    expect(mockSafetyAlert.type).toBe(AlertType.SAFETY);
...
describe('Enum Values', () => {
  test('StoryComplexity enum should have correct values', () => {
    ...
    expect(StoryComplexity.ADVANCED).toBe('advanced');
  });
  ...
  test('ReportFrequency enum should have correct values', () => {
    ...
    expect(ReportFrequency.ON_DEMAND).toBe('on-demand');
  });

  test('AlertType enum should have correct values', () => {
    expect(AlertType.SAFETY).toBe('safety');
    expect(AlertType.TIME_LIMIT).toBe('time-limit');
    expect(AlertType.CONTENT).toBe('content');
    expect(AlertType.BEHAVIOR).toBe('behavior');
    expect(AlertType.TECHNICAL).toBe('technical');
  });
